          ...
          <div className="flex items-start gap-3 mb-3">
            ...
            <div className="flex flex-col gap-2 ml-auto">
              ...
              <button
                ...
                className="px-2.5 py-1.5 bg-primary-600 hover:bg-primary-700 text-white text-xs font-medium rounded-md transition-colors flex items-center justify-center gap-1"
              >
