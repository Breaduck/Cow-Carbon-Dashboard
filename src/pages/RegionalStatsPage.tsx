      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
            ...
            <p className="text-xs text-gray-500 mt-1">개 농장</p>
          </div>

          <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
            <div className="flex items-center gap-2 mb-2">
              <div className="w-4 h-4 rounded-full" style={{ backgroundColor: LIVESTOCK_INFO.beef_cattle.color }} />
              <span className="text-sm font-medium text-gray-600">{LIVESTOCK_INFO.beef_cattle.nameKo}</span>
            </div>
          ...
          <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium text-gray-600">{LIVESTOCK_INFO.pig.nameKo}</span>
            </div>
          ...
          <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium text-gray-600">{LIVESTOCK_INFO.dairy_cattle.nameKo}</span>
            </div>
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-200">
              {regionalStats.map((stat, idx) => (
                <tr
                  key={stat.region}
                  className={`${idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'} hover:bg-primary-50 transition-colors`}
                >
